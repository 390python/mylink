...
c.execute('INSERT INTO users VALUES (%s,%s,%s )', user)
...
c.executemany('INSERT INTO users VALUES (%s,%s,%s )', users)
...
c.executemany('INSERT INTO albums VALUES (%s,%s,%s)', albums)
...
c.executemany('INSERT INTO pictures VALUES (%s,%s,%s)', pictures)
